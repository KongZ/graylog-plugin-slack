package org.graylog2.plugins.slack.rest;
...
import org.graylog2.plugins.slack.SlackActionPayload;
 ...
 */
@Path("/action")
public class SlackActionCallback implements PluginRestResource {
